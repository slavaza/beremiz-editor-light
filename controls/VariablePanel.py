...
from util.misc import NoTranslate
...
class VariablePanel(wx.Panel):
    ...
    def OnReturnTypeChanged(self, event):
        ...
        self.ParentWindow.RefreshView(variablepanel=False)
        self.ParentWindow._Refresh(TITLE, FILEMENU, EDITMENU, POUINSTANCESVIEWERPANEL, LIBRARYTREE)
        event.Skip()
    ...
    def OnDescriptionChanged(self, event):
        ...
        if new_description != old_description:
            ...
            self.ParentWindow._Refresh(TITLE, FILEMENU, EDITMENU, PAGETITLES, POUINSTANCESVIEWERPANEL, LIBRARYTREE)
        event.Skip()
