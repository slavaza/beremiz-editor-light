...
from controls import CustomTree, LibraryPanel, PouInstancesViewerPanel, SearchResultPanel
...
[
    ...
    POUINSTANCESVIEWERPANEL, LIBRARYTREE, SCALING, PAGETITLES
] = range(10)
...
class PLCEditorFrame(wx.Frame):
    """PLCEditorFrame Base Class"""
    ...
    def _init_ctrls(self, prnt):
        ...
        self.AUIManager.AddPane(
            ...
            BestSize(wx.Size(250, 600)).CloseButton(False))
        ...
        # -----------------------------------------------------------------------
        #        Creating PLCopen Project POU Instances Viewer Panel
        # -----------------------------------------------------------------------

        self.PouInstancesViewerPanel = PouInstancesViewerPanel(self.ProjectPanel, self, self.Controler)

        self.MainTabs["ProjectPanel"] = (self.ProjectPanel, _("Project"))
        self.LeftNoteBook.AddPage(*self.MainTabs["ProjectPanel"])

        self.ProjectPanel.SplitHorizontally(self.ProjectTree, self.PouInstancesViewerPanel, 300)
        ...
        self.SearchResultPanel = SearchResultPanel(self.LeftNoteBook, self)
        self.MainTabs["SearchResultPanel"] = (self.SearchResultPanel, _("Search"))
        self.LeftNoteBook.AddPage(*self.MainTabs["SearchResultPanel"])
        ...
        self.LeftNoteBook.AddPage(*self.MainTabs["LibraryPanel"])
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, id=ID_PLCOPENEDITOR, name='PLCEditorFrame',
        ...
        self.PouInstancesViewerPanel.SetTreeImageList(self.TreeImageList)
    ...
    def SelectTab(self, tab):
        for notebook in [self.LeftNoteBook]:
    ...
    def SetRefreshFunctions(self):
        self.RefreshFunctions = {
            ...
            POUINSTANCESVIEWERPANEL: self.RefreshPouInstancesViewerPanel,
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            if new_values != old_values:
                ...
                self._Refresh(TITLE, EDITORTOOLBAR, FILEMENU, EDITMENU, DISPLAYMENU,
                              PROJECTTREE, POUINSTANCESVIEWERPANEL, SCALING)
        dialog.Destroy()
    ...
    def ResetView(self):
        ...
        self.PouInstancesViewerPanel.ResetView()
    ...
    def OnPreviewMenu(self, event):
        ...
        if selected != -1:
            ...
            properties = self.Controler.GetProjectProperties(False)
    ...
    def OnUndoMenu(self, event):
        ...
        self._Refresh(TITLE, FILEMENU, EDITMENU, PROJECTTREE, POUINSTANCESVIEWERPANEL, LIBRARYTREE,
                      SCALING, PAGETITLES)
            ...
            if selected is not None and selected.IsOk():
                ...
                if function is not None:
                    ...
                    self._Refresh(TITLE, EDITORTOOLBAR, FILEMENU, EDITMENU, PROJECTTREE,
                                  POUINSTANCESVIEWERPANEL, LIBRARYTREE)
    ...
    def OnPouSelectedChanged(self, event):
        ...
        if selected >= 0:
            ...
            self.PouInstancesViewerPanel.SetPouType(tagname)
            window.RefreshView()
    ...
    def ProjectTreeItemSelect(self, select_item):
        if select_item is not None and select_item.IsOk():
            ...
            if item_infos["type"] in [ITEM_DATATYPE, ITEM_POU,
                ...
                self.PouInstancesViewerPanel.SetPouType(item_infos["tagname"])
    ...
    def RefreshPouInstancesViewerPanel(self):
        self.PouInstancesViewerPanel.RefreshView()
    ...
    ### TODO change tolbar management logic need
    ...
    def OnAddConfigurationMenu(self, event):
        ...
        if tagname is not None:
            self._Refresh(TITLE, FILEMENU, EDITMENU, PROJECTTREE, POUINSTANCESVIEWERPANEL)
    ...
    def OnRemovePouMenu(self, event):
        ...
        if self.ProjectTree.GetPyData(selected)["type"] == ITEM_POU:
            ...
            if self.CheckPouIsUsedBeforeDeletion(name):
                ...
                if idx is not None:
                    self.TabsOpened.DeletePage(idx)
                self._Refresh(TITLE, EDITORTOOLBAR, FILEMENU, EDITMENU, PROJECTTREE, POUINSTANCESVIEWERPANEL, LIBRARYTREE)
